package co.skliba.rideme.extensions
...
/**
 * For debugging only. Never should be used in prod code
 */
fun runDelayed(delay: Long, f: () -> Unit) = Handler(Looper.getMainLooper()).postDelayed(f, delay)

/**
 * For debug purposes
 */
fun toast(text: String) = Toast.makeText(RideMeApp.appComponent.context(), text, Toast.LENGTH_SHORT).show()
